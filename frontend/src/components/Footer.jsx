...
<footer class="bg-white dark:bg-gray-900">
    <div class="container px-6 py-8 mx-auto">
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between">
            <p class="text-sm text-gray-400">Made for MLH's Agent:Hacker 2</p>

            <div class="flex mt-3 -mx-2 sm:mt-0">
                <a href="#" class="mx-2 text-sm text-gray-400 transition-colors duration-300 hover:text-gray-500 dark:hover:text-gray-300" aria-label="Reddit"> Github </a>
